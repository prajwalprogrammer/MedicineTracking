    ...
    return (
        <div className='trackBlock'>
            ...
            <form onSubmit={handlerSubmit}>
                <input className="form-control-sm supplyInp" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-success btn-sm trackBtn" onSubmit={handlerSubmit}>Track</button>
            </form>
        </div>
    )
}
